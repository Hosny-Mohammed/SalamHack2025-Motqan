...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? HomepageWidget() : AuthinticationWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => appStateNotifier.loggedIn
              ? HomepageWidget()
              : AuthinticationWidget(),
        ),
        FFRoute(
          name: AuthinticationWidget.routeName,
          path: AuthinticationWidget.routePath,
          builder: (context, params) => AuthinticationWidget(),
        ),
        FFRoute(
