                                  ...
                                  children: [
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.achivePeriodTextController,
                                          focusNode:
                                        ...
                                        onPressed: () async {
                                          ...
                                          _model.generatedPhases =
                                            ...
                                            (String targetName,
                                                    ...
                                                    String details,
                                                    String backGround) {
                                              return 'Help me define my target where I lack background. My target is to $targetName, and I want to achieve it in $achivePeriod days.';
                                            }(
                                                _model.targetNameTextController
                                                    .text,
                                                int.parse(_model
